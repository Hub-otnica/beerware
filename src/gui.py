...
class MainWindow(QMainWindow):
    def __init__(self, config):
        ...
        self.pid_kp = self.pid_settings.get("kp", 0.7)
        self.pid_ki = self.pid_settings.get("ki", 0.03)
        self.pid_kd = self.pid_settings.get("kd", 0.12)
        self.pid_window_seconds = max(
            0.5,
            self.pid_settings.get("window_seconds", 10.0),
        )
        self.pid_integral_min = self.pid_settings.get("integral_min", -20.0)
        self.pid_integral_max = self.pid_settings.get("integral_max", 20.0)
    ...
    def _build_ui(self):
        ...
        self.control_button.setGeometry(360, 20, 230, 32)
